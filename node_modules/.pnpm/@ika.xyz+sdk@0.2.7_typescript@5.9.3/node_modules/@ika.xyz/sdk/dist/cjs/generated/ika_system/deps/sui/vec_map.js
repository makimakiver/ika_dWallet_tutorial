...
function Entry(...typeParameters) {
  return new import_utils.MoveStruct({ name: `${$moduleName}::Entry<${typeParameters[0].name}, ${typeParameters[1].name}>`, fields: {
    key: typeParameters[0],
    value: typeParameters[1]
  } });
}
function VecMap(...typeParameters) {
  return new import_utils.MoveStruct({ name: `${$moduleName}::VecMap<${typeParameters[0].name}, ${typeParameters[1].name}>`, fields: {
