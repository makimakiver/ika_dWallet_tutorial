...
const SystemInner = new MoveStruct({ name: `${$moduleName}::SystemInner`, fields: {
...
const SystemEpochInfoEvent = new MoveStruct({ name: `${$moduleName}::SystemEpochInfoEvent`, fields: {
  epoch: bcs.u64(),
  protocol_version: bcs.u64(),
  total_stake: bcs.u64(),
...
const SystemCheckpointInfoEvent = new MoveStruct({ name: `${$moduleName}::SystemCheckpointInfoEvent`, fields: {
  epoch: bcs.u64(),
  sequence_number: bcs.u64()
} });
const SetNextProtocolVersionEvent = new MoveStruct({ name: `${$moduleName}::SetNextProtocolVersionEvent`, fields: {
  epoch: bcs.u64(),
  next_protocol_version: bcs.u64()
} });
const SetEpochDurationMsEvent = new MoveStruct({ name: `${$moduleName}::SetEpochDurationMsEvent`, fields: {
  epoch: bcs.u64(),
  epoch_duration_ms: bcs.u64()
} });
const SetStakeSubsidyStartEpochEvent = new MoveStruct({ name: `${$moduleName}::SetStakeSubsidyStartEpochEvent`, fields: {
  epoch: bcs.u64(),
  stake_subsidy_start_epoch: bcs.u64()
} });
const SetStakeSubsidyRateEvent = new MoveStruct({ name: `${$moduleName}::SetStakeSubsidyRateEvent`, fields: {
  epoch: bcs.u64(),
  stake_subsidy_rate: bcs.u16()
} });
const SetStakeSubsidyPeriodLengthEvent = new MoveStruct({ name: `${$moduleName}::SetStakeSubsidyPeriodLengthEvent`, fields: {
  epoch: bcs.u64(),
  stake_subsidy_period_length: bcs.u64()
} });
const SetMinValidatorCountEvent = new MoveStruct({ name: `${$moduleName}::SetMinValidatorCountEvent`, fields: {
  epoch: bcs.u64(),
  min_validator_count: bcs.u64()
} });
const SetMaxValidatorCountEvent = new MoveStruct({ name: `${$moduleName}::SetMaxValidatorCountEvent`, fields: {
  epoch: bcs.u64(),
  max_validator_count: bcs.u64()
} });
const SetMinValidatorJoiningStakeEvent = new MoveStruct({ name: `${$moduleName}::SetMinValidatorJoiningStakeEvent`, fields: {
  epoch: bcs.u64(),
  min_validator_joining_stake: bcs.u64()
} });
const SetMaxValidatorChangeCountEvent = new MoveStruct({ name: `${$moduleName}::SetMaxValidatorChangeCountEvent`, fields: {
  epoch: bcs.u64(),
  max_validator_change_count: bcs.u64()
} });
const SetRewardSlashingRateEvent = new MoveStruct({ name: `${$moduleName}::SetRewardSlashingRateEvent`, fields: {
  epoch: bcs.u64(),
  reward_slashing_rate: bcs.u16()
} });
const SetApprovedUpgradeEvent = new MoveStruct({ name: `${$moduleName}::SetApprovedUpgradeEvent`, fields: {
  epoch: bcs.u64(),
  package_id: bcs.Address,
  digest: bcs.option(bcs.vector(bcs.u8()))
} });
const EndOfPublishEvent = new MoveStruct({ name: `${$moduleName}::EndOfPublishEvent`, fields: {
  epoch: bcs.u64()
} });
const SetOrRemoveWitnessApprovingAdvanceEpochEvent = new MoveStruct({ name: `${$moduleName}::SetOrRemoveWitnessApprovingAdvanceEpochEvent`, fields: {
  epoch: bcs.u64(),
