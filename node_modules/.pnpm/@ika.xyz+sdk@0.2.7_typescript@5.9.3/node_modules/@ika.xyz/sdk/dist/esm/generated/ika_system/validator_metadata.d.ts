...
export declare const ValidatorMetadata: MoveStruct<{
    image_url: import("@mysten/bcs").BcsType<string, string, "string">;
    project_url: import("@mysten/bcs").BcsType<string, string, "string">;
...
}, "@local-pkg/system::validator_metadata::ValidatorMetadata">;
