...
}, "@local-pkg/2pc-mpc::ika_dwallet_2pc_mpc_display::ObjectDisplay">;
export declare const PublisherKey: MoveTuple<import("@mysten/bcs").BcsType<boolean, boolean, "bool">[], "@local-pkg/2pc-mpc::ika_dwallet_2pc_mpc_display::PublisherKey">;
